...
const MoltenMetal = () => {
  useEffect(() => {
    var c = document.getElementById("animated__background");
    var $ = c.getContext("2d");
    ...
    for (var k = 0; k < w2h; ++k) arr[k] = Math.random() * 1.5 - 0.5;
  ...
  return <canvas style={style} id="animated__background"></canvas>;
};
